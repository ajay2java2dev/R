...
Estep.Original.Class <- function (data, G, para) {
...
#E-Step Sample 2
```{r}
Estep.Original.Class.Modified <- function (data, G, para) {
  #para <- para0
  prob <- para$prob
  mean <- para$mean
  sigma <- para$Sigma
  ...
  ank = matrix(0,dataRows,dataCols)
  ...
  bnk = matrix(0,dataRows,dataCols)
...
Estep <- function(data, G, para){
  ...
  #post.prob = Estep.Original.Class (data, G, para) * prob[g]
  
  #or use approach 2 using ank and bnk - https://piazza.com/class/kjvsp15j2g07ac?cid=301
  #post.prob = Estep.Original.Class.Modified (data, G, para) * prob[g]
