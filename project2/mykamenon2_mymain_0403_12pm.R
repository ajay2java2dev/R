...
update_test <- function(test_current) {
  ...
  #test <<- test %>% rowwise() %>% mutate(Weekly_Pred = ifelse(t==1, Weekly_Pred1, ifelse(t>1 & t<7, Weekly_Pred3, Weekly_Pred2)))
  
  test <<- test %>% rowwise() %>% mutate(Weekly_Pred = ifelse(t == 5 | t == 6, Weekly_Pred3, 
...
#tslm basic
tslm_basic_model <- function(train_ts, test_ts){
...
#> print(wae)
#[1] 1665.042 1478.789 1455.275 1588.028 2486.611 2013.825 1681.627 1407.322 1421.149 1417.278
#> mean(wae)
#[1] 1661.495
